...
# 输入框, 只读
Entry(f1, width=5, textvariable=leng, state='readonly').grid(row='0', column='1')
Button(f1, text='+', command=plus).grid(row='0', column='3')
Button(f1, text='-', command=neg).grid(row='0', column='4')
f1rb = Frame(f1)
f1rb.grid(row='1', column='1')
Label(f1, text='密码强度').grid(row='1', column='0')
# 单选按钮
Radiobutton(f1rb, text='简单',value=True).grid(row='1', column='1')
Radiobutton(f1rb, text='一般',value=False).grid(row='1', column='2')
Radiobutton(f1rb, text='复杂',value=False).grid(row='1', column='3')
Entry(tk).pack()
